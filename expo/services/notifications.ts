  ...
  try {
    await Notifications.scheduleNotificationAsync({
      content: {
        ...
        body: message || `Votre stress est à ${stressLevel}/100. C'est dans ces moments-là que 90% des tilts surviennent. Faites attention.`,
  ...
  try {
    await Notifications.scheduleNotificationAsync({
      content: {
        ...
        body: `Votre BPM est à ${heartRate}. C'est dans ces moments-là que 90% des tilts surviennent. Faites attention.`,
